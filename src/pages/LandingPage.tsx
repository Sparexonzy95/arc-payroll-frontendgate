...
import arcflowLogo from '../assets/arcflow-logos.png'

import { Button } from '../components/landing/botton'
import { Card } from '../components/landing/card'

// ✅ landing-only theme (scoped)
          ...
          <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-3 py-3 sm:px-4 md:py-5 lg:px-0">
            ...
            <div className="flex items-center gap-2">
              <img
                src={arcflowLogo}
                alt="Arcflow"
                className="h-8 w-auto xs:h-9 md:h-11"
                draggable={false}
              />
            </div>
